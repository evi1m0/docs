...
[Webhook API](https://docs.chainbase.com/reference/webhook-api-overview-1) enables you to receive real-time requests to your backends whenever the following events occur on dataset tables: `insert`, `update`
</Note>
...
- [Webhook API Overview](https://docs.chainbase.com/reference/webhook-api-overview-1)
