...
Chainbase API [getTokenPrice](/reference/gettokenprice) takes the chain id and the contract address of a certain ERC20 token as parameters, and returns the price of that token.
