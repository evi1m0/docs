...
Chainbase API [getTokenMetadata](/reference/gettokenmetadata) takes the chain id and token contract address as parameters, and returns the metadata of the ERC20 token.
