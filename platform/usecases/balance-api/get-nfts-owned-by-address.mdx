...
Chainbase API [getAccountNFTs](/reference/getaccountnfts) takes the chain id and wallet address as parameters, and returns the NFTs owned by the input wallet.
