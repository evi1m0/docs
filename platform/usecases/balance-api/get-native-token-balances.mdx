...
Chainbase API [getAccountBalance](/reference/getaccountbalance) takes the chain id and wallet address as parameters, and returns the value of native token balances.
