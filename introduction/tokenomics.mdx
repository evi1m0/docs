...
## **Reward Structure**
![death spiral](../images/tokenomic.png)
...
- **95%** is distributed to Operators and their delegators. This portion of the fees primarily incentivizes Operators to maintain and optimize computing resources, ensuring efficient data query processing.
- **4.9%** is distributed to Validators and their delegators. Validators play a crucial role in ensuring the security and accuracy of transactions and data processing during queries.
- **0.1%** is allocated to the community pool to fund community activities, development, and network improvements.

### **Incentive On-Chain Data Pools**
Various blockchain projects can stake their native tokens into a dedicated incentive pool to encourage Operators to provide scalable data processing services for these chains.

- Blockchain projects establish a reward pool by staking their native tokens, attracting Operators to provide data services. The tokens in these reward pools are used to incentivize Operators to expand and optimize data processing infrastructure.
- This mechanism ensures that blockchain projects receive efficient data processing services while providing Operators with additional revenue sources.

#### **Distribution**

- **95%** is distributed to Operators and their delegators based on the quality and quantity of data processing services provided for blockchain projects.
- **4.9%** is distributed to Validators and their delegators, who also participate in ensuring the security and accuracy of data processing.
- **0.1%** is allocated to the community pool to support community building and network development.

### **Block Rewards**
Provided to help bootstrap the Network (-3% Annual Inflation)
...
- **98%** is distributed to Validators and their delegators, who maintain the consensus mechanism of the blockchain and verify transactions.
- **2%** is allocated to the community pool for the long-term development and improvement of the network.
...
- Receive 95% of data query fees, incentivizing them to maintain and optimize computing resources for efficient data query processing.
- Receive 95% of the rewards from the incentive on-chain data pools, encouraging them to provide efficient data processing services for blockchain projects.
...
- Receive 4.9% of data query fees to ensure the security and accuracy of transactions and data processing.
- Receive 4.9% of the rewards from the incentive on-chain data pools, participating in ensuring the security and accuracy of data processing.
- Receive 98% of block rewards, incentivizing them to maintain network security and stability, and ensure the proper functioning of the blockchain.
...
- Earn transaction fees based on the usage of their code and datasets. Data developers need to pay CBT fees when building and querying datasets.
- Participate in funding and bounty programs to encourage more high-quality code and dataset contributions.
...
- **Broad Utility**: CBT tokens are required for various activities within the network, including transaction fees, staking, and accessing datasets, ensuring continuous demand.
- **Fee Adjustments**: Transaction fees can be adjusted based on network activity and demand to balance economic incentives and operational costs.
