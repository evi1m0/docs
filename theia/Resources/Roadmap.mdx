...
## Phase 2: Knowledge Construction and Theia Expert Model (Agent)

📅 August 1, 2024, 12:25:00 PM +UTC

We will create and expand the "Crypto Patterns" (i.e., expert and AI knowledge database) with community contributions and provide an interface to build Theia Agent Expert and any users can upload their own prompts (expert experiences) through this interface. Once reviewed by us, the agent can run on our model and interact with the internal Chainbase DB.
...
## Phase 4: Continuous Model Tuning and Patterns Accumulation
